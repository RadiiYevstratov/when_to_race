...
Series still awaiting discovery (wrc) deliberately has no module yet. The runner reports them as unimplemented rather
...
from . import f1, fixture, imsa, indycar, motogp, nascar, wec, wsbk  # noqa: F401  - imported for the register() side effect
