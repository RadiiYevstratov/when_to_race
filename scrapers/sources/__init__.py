...
Series still awaiting discovery (wrc, imsa, nascar) deliberately have no
module yet. The runner reports them as unimplemented rather
...
from . import f1, fixture, indycar, motogp, wec, wsbk  # noqa: F401  - imported for the register() side effect
