...
Series still awaiting discovery (wrc, imsa, indycar, nascar)
deliberately have no module yet. The runner reports them as unimplemented rather
...
from . import f1, fixture, motogp, wec, wsbk  # noqa: F401  - imported for the register() side effect
